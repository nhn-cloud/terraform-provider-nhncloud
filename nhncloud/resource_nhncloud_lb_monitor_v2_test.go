		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBV2MonitorExists(t, "nhncloud_lb_monitor_v2.monitor_1", &monitor),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"nhncloud_lb_monitor_v2.monitor_1", "name", "monitor_1_updated"),
					resource.TestCheckResourceAttr("nhncloud_lb_monitor_v2.monitor_1", "delay", "30"),
					resource.TestCheckResourceAttr("nhncloud_lb_monitor_v2.monitor_1", "timeout", "15"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBV2MonitorExists(t, "nhncloud_lb_monitor_v2.monitor_1", &monitor),
					resource.TestCheckResourceAttr("nhncloud_lb_monitor_v2.monitor_1", "max_retries_down", "8"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"nhncloud_lb_monitor_v2.monitor_1", "name", "monitor_1_updated"),
					resource.TestCheckResourceAttr("nhncloud_lb_monitor_v2.monitor_1", "max_retries_down", "3"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLBV2MonitorExists(t, "nhncloud_lb_monitor_v2.monitor_1", &monitor),
					resource.TestCheckResourceAttr("nhncloud_lb_monitor_v2.monitor_1", "type", "UDP-CONNECT"),
				),
			},
		},
	})
...
func testAccCheckLBV2MonitorDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "nhncloud_lb_monitor_v2" {
			continue
		}
...
resource "nhncloud_lb_monitor_v2" "monitor_1" {
  name = "monitor_1"
  type = "PING"
  delay = 20
  timeout = 10
