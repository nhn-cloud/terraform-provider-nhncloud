...
func TestUnitFlattenBlockStorageVolumeV2Attachments(t *testing.T) {
	...
	actualAttachments := flattenBlockStorageVolumeV2Attachments(blockStorageVolumeV2VolumeFixture().Attachments)
...
func TestUnitBlockStorageVolumeV2AttachmentHash(t *testing.T) {
	...
	actualHashcode := blockStorageVolumeV2AttachmentHash(attachments[0])
